    ...
    <div class="container">
        <div class="row">
            <div class="col h-250 bg-primary p-5 text-white text-center">
                ...
                <p class="p-3">পিএইচপি বেসিক – ডিফাইন ফাংশন -কন্সট্যান্ট ভ্যালু এসাইন – পর্ব ৩</p>
        ...
        <div class="row">
            <div class="col code-box py-5 text-white">
                <div class="input">
                    <h2>PHP code</h2>
                    <textarea class="w-100 p-3 bg-white text-dark fs-4" name="codearea" id="codearea" cols="30" rows="5">
                        define('USER', 'Md Kamal Hosen');
                        define('MOBILE', 123456789);
                        echo "Name : " . USER; 
                        echo "<br>";
                        echo "Mobile : " .MOBILE;</textarea>
                </div>
                <div class="output">
                    <h2>Result</h2>
