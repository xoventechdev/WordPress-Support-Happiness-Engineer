    ...
    <div class="container">
        <div class="row">
            <div class="col h-250 bg-primary p-5 text-white text-center">
                ...
                <p class="p-3">পিএইচপি বেসিক – অ্যারে – পর্ব ৭</p>
        ...
        <div class="row">
            <div class="col code-box py-5 text-white">
                <div class="input">
                    ...
                    $jobs = ['Web Developer', 'App Developer', 60, false];


                    if($jobs[0] == 'Web Developer'){
                    echo 'Hello, I\'m a '.$jobs[0] . '. I also know '. $jobs[1].'.  I work more than '.$jobs[2].' hours in a week.<br>';
                    } else {
                        echo 'Hello, I\'m a Android Developer. <br>';
                    }

                    if($jobs[3]){
                        echo 'It\'s true that....... <br>';
                    } else {
                        echo 'It\'s fasle that....... <br>';
                    }
                    </textarea>
                </div>
                <div class="output">
                    ...
                    <?php
                        ...
                        echo ' $jobs = [\'Web Developer\', \'App Developer\', 60, false]; <br><br>';
